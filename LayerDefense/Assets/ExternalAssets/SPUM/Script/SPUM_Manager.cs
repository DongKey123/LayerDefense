...
public class SPUM_Manager : MonoBehaviour
{
    ...
    public void DrawItemProcess()
    {
        ...
        {
            string path = "Assets/ExternalAssets/SPUM/SPUM_Sprites/BodySource/Species/";
            DirectoryInfo dir = new DirectoryInfo(path);
            FileInfo[] info = dir.GetFiles("*.*");
        ...
        {
            string path = "Assets/ExternalAssets/SPUM/SPUM_Sprites/RideSource/";
            DirectoryInfo dir = new DirectoryInfo(path);
            FileInfo[] info = dir.GetFiles("*.*");
    ...
    public void AnimContCheck()
    {
        ...
        // if(File.Exists("Assets/ExternalAssets/SPUM/Res/Animation/NormalAnimator.controller"))
        // {
        //     tC = (RuntimeAnimatorController)AssetDatabase.LoadAssetAtPath("Assets/ExternalAssets/SPUM/Res/Animation/NormalAnimator.controller",typeof(RuntimeAnimatorController));
        ...
        // if(File.Exists("Assets/ExternalAssets/SPUM/SPUM_Sprites/Packages/Undead/Animation/UndeadAnimator.controller"))
        // {
        //     tC = (RuntimeAnimatorController)AssetDatabase.LoadAssetAtPath("Assets/ExternalAssets/SPUM/SPUM_Sprites/Packages/Undead/Animation/UndeadAnimator.controller",typeof(RuntimeAnimatorController));
    ...
    public void InstallSpriteData()
    {
        ...
        if(AssetDatabase.CopyAsset("Assets/ExternalAssets/SPUM/SPUM_Sprites/Items","Assets/Resources/SPUM/SPUM_Sprites/Items"))
        {
        ...
        if(AssetDatabase.CopyAsset("Assets/ExternalAssets/SPUM/SPUM_Sprites/Packages","Assets/Resources/SPUM/SPUM_Sprites/Packages"))
        {
    ...
    {
        if(File.Exists("Assets/ExternalAssets/SPUM/Script/SPUM_TexutreList.cs"))
        {
            Debug.Log("Filex Exits, will delete it");
            FileUtil.DeleteFileOrDirectory("Assets/ExternalAssets/SPUM/Script/SPUM_TexutreList.cs");
        }
    }
